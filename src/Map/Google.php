...
class Google extends AbstractMap
{
     ...
     * @var string
     */
    protected $api = 'https://maps.uoolu.com/maps/api/js?v=3.exp&sensor=false&key=%s&libraries=places';
        ...
        (function() {
            function init(name) {
                ...
                var autocomplete = new google.maps.places.Autocomplete(
                    document.getElementById("search-{$id['latitude']}{$id['longitude']}")
                );
